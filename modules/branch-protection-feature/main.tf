...
variable required_pull_request_reviews { default = false }
variable "required_approving_review_count" { default = 1 }
variable "restrict_dismissals" { default = false }

variable "required_status_checks" { default = false }
...
variable "enforce_admins" { default = false }

variable "restrict_pushes" { default = false }
variable "block_creations" { default = false }

variable "allows_force_pushes" { default = true }
variable "allows_deletion" { default = true }
